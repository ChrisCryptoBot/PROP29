    ...
    const mockData: DataItem[] = [
      {
        id: '1',
        title: 'Sample Item 1',
        description: 'This is a sample item for the Smart Parking module',
        status: 'active',
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Real-time space availability with reservation system</p>
          </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" className="input" defaultValue="Smart Parking" />
                  </div>
                  <div>
                    <label className="form-label">Status</label>
                    <select className="select">
