    ...
    const mockData: DataItem[] = [
      {
        id: '1',
        title: 'Sample Item 1',
        description: 'This is a sample item for the Digital Handover module',
        status: 'active',
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Digital Handover</h1>
            <p className="text-gray-600 mt-1">Automated shift transitions with AI-generated briefings</p>
          </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" className="input" defaultValue="Digital Handover" />
                  </div>
                  <div>
                    <label className="form-label">Status</label>
                    <select className="select">
