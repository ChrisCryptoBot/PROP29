    ...
    const mockData: DataItem[] = [
      {
        id: '1',
        title: 'Sample Item 1',
        description: 'This is a sample item for the Smart Lockers module',
        status: 'active',
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">IoT-enabled lockers with remote monitoring and maintenance</p>
          </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" className="input" defaultValue="Smart Lockers" />
                  </div>
                  <div>
                    <label className="form-label">Status</label>
                    <select className="select">
