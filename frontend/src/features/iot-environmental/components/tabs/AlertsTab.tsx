      ...
      <div className="bg-black/20 border border-white/10 rounded-2xl overflow-hidden backdrop-blur-xl shadow-2xl">
        ...
        <div className="p-6">
          {activeAlerts.length === 0 ? (
            <div className="text-center py-24 bg-black/20 rounded-[2.5rem] border border-dashed border-white/10 mx-4 group relative overflow-hidden transition-all duration-700 hover:bg-black/40">
              <div className="absolute inset-0 bg-blue-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-1000" />

              <div className="relative z-10">
                <div className="w-24 h-24 bg-white/5 border border-white/10 rounded-3xl flex items-center justify-center mx-auto mb-8 transition-all duration-700 group-hover:scale-110 group-hover:rotate-6 group-hover:border-blue-500/30 shadow-2xl relative">
            ...
            <div className="space-y-6">
              ...
              {Object.entries(
                ...
                <div key={sensorId} className="bg-white/5 border border-white/10 rounded-xl overflow-hidden">
                  {/* Group Header */}
            ...
            <div className="mt-8 border-t border-white/10 pt-6">
              ...
              <div className="flex flex-wrap gap-2">
                {snoozedSensors.map(sensorId => (
                  <div key={sensorId} className="flex items-center gap-2 px-3 py-1.5 bg-white/5 border border-white/10 rounded-lg group hover:border-white/20 transition-colors">
