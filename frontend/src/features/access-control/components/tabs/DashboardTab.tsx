 ...
 * Memoized to prevent re-renders when other context state updates
 */
  ...
  if (loading.metrics && !contextMetrics) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] space-y-4">
        ...
        <p className="text-[10px] font-black text-blue-400 uppercase tracking-widest animate-pulse">Loading Dashboard...</p>
      </div>
    );
  }

  return (
    <div className="space-y-6" role="main" aria-label="Access Control Dashboard">
      ...
      {criticalUnread.length > 0 && (
        <Card className="glass-card bg-red-950/20 border border-white/5 shadow-2xl overflow-hidden" role="alert" aria-live="polite">
          <div className="absolute top-0 left-0 w-1 h-full bg-red-500" />
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-5">
                <div className="w-12 h-12 bg-gradient-to-br from-red-600/80 to-slate-900 rounded-xl flex items-center justify-center border border-white/5 shadow-2xl" aria-hidden="true">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4" role="group" aria-label="Access control key metrics">
        {/* Total Access Points */}
        <Card className="bg-slate-900/50 backdrop-blur-xl border border-white/5 shadow-2xl hover:bg-white/5 hover:border-white/5 transition-all duration-300 group" role="article">
        ...
        {/* Active Users */}
        <Card className="bg-slate-900/50 backdrop-blur-xl border border-white/5 shadow-2xl hover:border-white/5 transition-all duration-300 group" role="article">
          <CardContent className="pt-6 px-6 pb-6 relative">
            <div className="absolute top-4 right-4">
            ...
            <div className="flex items-center justify-between mb-4 mt-2">
              <div className="w-12 h-12 bg-gradient-to-br from-indigo-600/80 to-slate-900 rounded-xl flex items-center justify-center shadow-2xl border border-white/5 group-hover:scale-110 transition-transform" aria-hidden="true">
        ...
        {/* Access Events */}
        <Card className="bg-slate-900/50 backdrop-blur-xl border border-white/5 shadow-2xl hover:bg-white/5 transition-all duration-300 group" role="article">
          <CardContent className="pt-6 px-6 pb-6 relative">
            <div className="absolute top-4 right-4">
      ...
      <Card className="bg-slate-900/50 backdrop-blur-xl border border-white/5 shadow-2xl overflow-hidden">
        <CardHeader className="border-b border-white/5 px-6 py-4">
          <CardTitle className="flex items-center justify-between text-xl text-[color:var(--text-main)] font-black uppercase tracking-tighter">
            <div className="flex items-center">
              <div className="w-12 h-12 bg-gradient-to-br from-red-600/80 to-slate-900 rounded-xl flex items-center justify-center mr-3 shadow-2xl border border-white/5" aria-hidden="true">
      ...
      <Card className="bg-red-950/20 border-2 border-red-500/50 shadow-2xl" role="alert" aria-live="assertive">
              ...
              {activeAlerts.map((alert) => (
                <div
                  ...
                  className={cn(
                    ...
                    alert.severity === 'critical' ? 'bg-red-500/10 border-red-500/50 shadow-2xl' : 'bg-orange-500/5 border-orange-500/30 shadow-2xl'
                  )}
                  role="listitem"
                >
          ...
          {loading.accessEvents ? (
            ...
            <div className="space-y-3" role="list" aria-label="Recent access events">
              {recentEvents.map((event) => (
                <div
                  key={event.id}
                  className="flex items-center justify-between p-4 bg-slate-900/30 border border-white/5 rounded-2xl group hover:bg-white/5 hover:border-white/5 transition-all shadow-2xl"
                  role="listitem"
                >
                  <div className="flex items-center space-x-4">
                    <div
                      className={cn(
                        "w-12 h-12 rounded-xl flex items-center justify-center border border-white/5 shadow-2xl group-hover:scale-110 transition-transform duration-300",
                    ...
                    <div>
                      ...
                      <p className="text-[9px] text-[color:var(--text-sub)]/40 italic font-medium">{event.location}</p>
                    </div>
                  </div>
...
/**
 * DashboardTab with ErrorBoundary
...
export const DashboardTab: React.FC = React.memo(() => {
  return (
    <ErrorBoundary moduleName="Access Control Dashboard">
