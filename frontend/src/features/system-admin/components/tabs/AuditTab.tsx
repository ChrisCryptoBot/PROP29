                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div className="group">
                        ...
                        <div className="relative">
                            ...
                            <select className="w-full pl-11 pr-10 py-3 border border-white/10 bg-white/5 text-white font-bold rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/40 appearance-none cursor-pointer hover:bg-white/10 transition-all uppercase text-xs">
                    ...
                    <div className="md:col-span-2 relative self-end group">
                        <SearchBar
                            ...
                            className="bg-white/5 border-white/10 rounded-xl py-3 pl-11 shadow-inner focus:bg-white/10"
                        />
