...
import { modalConfig, MODAL_TYPES } from '../../config/modalConfig';
...
const PlaceholderModal = ({ title, isOpen, onClose }) => {
...
export const ModalManager = () => {
  ...
  const renderModal = (modalId, modal) => {
    const { modalType, data, config } = modal;
